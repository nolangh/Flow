...
export default function NotFoundScreen() {
  return (
    <View style={{ flex: 1, backgroundColor: "#000", alignItems: "center", justifyContent: "center", padding: 32 }}>
      ...
      <Text style={{ color: Colors.text.primary, fontSize: 22, fontFamily: Fonts.extraBold, marginBottom: 8 }}>
        Page not found
      </Text>
      <Text style={{ color: Colors.text.muted, fontSize: 14, textAlign: "center", marginBottom: 32, lineHeight: 20 }}>
        The screen you're looking for doesn't exist.
      </Text>
      <Link href="/" style={{ color: Colors.accent, fontSize: 15, fontFamily: Fonts.semiBold }}>
        Go Home
      </Link>
    </View>
  );
